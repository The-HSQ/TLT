...
//                                 <Link
//                                     to="/login"
//                                     className="tracking-[1px] flex justify-center items-center gap-1 bg-btn text-white px-6 py-2 rounded-full cursor-pointer transition-all duration-300 ease-in-out font-semibold"
//                                 >
                    ...
                    <div className="flex items-center">
                        {isAuthenticated ? (
                            ...
                            <div className="flex gap-4">
                                <Link
                                    to="/demo"
                                    className="tracking-[1px] text-sm flex justify-center items-center gap-2 bg-transparent text-black py-3 rounded cursor-pointer transition-all duration-300 ease-in-out hover:translate-y-0.5 font-semibold"
                                >
                                    Get Demo
                                </Link>
                                <Link
